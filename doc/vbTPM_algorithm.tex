...
\subsection{Extension to factorial model}
...
hidden processes. We implemented a brute force approach to this
problem, where we define new composite hidden states $\hat
s_t=(s_t,c_t)$ and modify the above algorithm to run this composite
model, which mainly involves book-keeping to 
